...
export const barChartData = [
  [
    { x: "Nirma University", y: 46 },
    { x: "DAIICT", y: 27 },
    { x: "PDPU", y: 26 },
  ],
  [
    { x: "Nirma University", y: 37 },
    { x: "DAIICT", y: 23 },
    { x: "PDPU", y: 18 },
  ],
  [
    { x: "Nirma University", y: 38 },
    { x: "DAIICT", y: 17 },
    { x: "PDPU", y: 26 },
  ],
];
...
export const recentTransactions = [
  {
    ...
    amount: "Published",
    title: "Cryptocurrency security algoritms",
    desc: "Meet Makwana",
    iconColor: "#03C9D7",
    iconBg: "#E5FAFB",
    pcColor: "green-600",
...
export const weeklyStats = [
  {
    ...
    title: "Utsav Raj Goyal",
    desc: "Electronics & Communication Department",
    iconBg: "#FB9678",
    pcColor: "red-600",
  },
  {
    ...
    title: "Chirag Jain",
    desc: "Computer Science Department",
    iconBg: "rgb(254, 201, 15)",
    pcColor: "red-600",
  },
  {
...
export const customersData = [
  {
    ...
    ProjectName: "Big Data Analytics for Healthcare",
    Status: "Active",
    StatusBg: "#8BE78B",
    Weeks: "40",
    Budget: "$2.4k",
  ...
  },
  {
    ...
    CustomerName: "Abhay Shah",
    CustomerEmail: "abhayshah3017@gmail.com",
    ProjectName: "Big Data Analytics for Chemistry",
    Status: "Pending",
  ...
  },
  {
    ...
    CustomerName: "Jaimin Shah",
    CustomerEmail: "jaiminShah007@gmail.com",
    ProjectName: "Quantum Computing for Materials Science",
    Status: "Completed",
  ...
  },
  {
    ...
    CustomerName: "Meet Makwana",
    CustomerEmail: "meetMakwana4@gmail.com",
    ProjectName: "Quantum Computing for Chemistry",
    Status: "Cancel",
    CustomerImage: avatar2,
    StatusBg: "red",
    Weeks: "34",
  ...
  },
  {
    ...
    CustomerEmail: "nirav@gmail.com",
    CustomerImage: avatar2,
    ProjectName: "Green Chemistry for Sustainable Manufacturing",
    Status: "Active",
    StatusBg: "#8BE78B",
    Weeks: "40",
    Budget: "$2.4k",
  ...
  },
  {
    ...
    CustomerName: "Sunil Joshi",
    CustomerEmail: "sunil@gmail.com",
    ProjectName: "Materials Science for Energy Applications",
    Status: "Active",
    CustomerImage: avatar3,
  ...
  },
  {
    ...
    CustomerEmail: "ankur@yahoo.com",
    ProjectName: "A New Method for Chemical Synthesis of Organic Compounds",
    Status: "Pending",
    CustomerImage: avatar4,
    StatusBg: "#FEC90F",
    Weeks: "19",
  ...
  },
  {
    ...
    CustomerName: "Dvij Pandya",
    CustomerEmail: "dvij@gmail.com",
    ProjectName: "Computational Biology for Gene Expression Analysis",
    Status: "Completed",
    CustomerImage: avatar,
    StatusBg: "#8BE78B",
    Weeks: "34",
  ...
  },
  {
    ...
    CustomerEmail: "mahesh@gmail.com",
    ProjectName: "Machine Learning for Drug Discovery",
    Status: "Cancel",
    CustomerImage: avatar2,
    StatusBg: "red",
    Weeks: "34",
  ...
  },
  {
    ...
    CustomerEmail: "nirav@gmail.com",
    CustomerImage: avatar2,
    ProjectName: "A Deep Learning Approach to Protein Structure Prediction",
    Status: "Active",
    StatusBg: "#8BE78B",
    Weeks: "40",
    Budget: "$2.4k",
...
export const employeesData = [
  ...
  },
  {
    ...
    HireDate: "01/02/2023",
    Country: "Pakistan",
    ReportsTo: "Prof. Lavangia",
    EmployeeImage: avatar4,
  },
  {
    EmployeeID: 4,
    Name: "Siegbert Sharma",
  ...
  },
  {
    ...
    HireDate: "08/02/2023",
    Country: "Afganistan",
    ReportsTo: "Prof Chinmay",
    EmployeeImage: avatar,
  },
  {
    EmployeeID: 4,
    Name: "Penjani Subramaniyam",
    Title: "Quantum Computing",
    HireDate: "01/02/2023",
    Country: "India",
    ReportsTo: "Prof. Patel",
    EmployeeImage: avatar,
  },
  {
    EmployeeID: 5,
  ...
  {
    EmployeeID: 2,
    Name: "Nasimiyu Dudiya",
    Title: "VLSI",
    HireDate: "14/08/2022",
    Country: "USA",
    ReportsTo: "Prof. Mehta",
    EmployeeImage: avatar3,
  },
  {
    EmployeeID: 1,
...
export const ordersData = [
  {
    OrderID: 10248,
    CustomerName: "Sumit Sinha",

    TotalAmount: 32,
    OrderItems: "Big Data Analytics for Healthcare",
    Location: "Journal of Medical Systems",
    Status: "pending",
    StatusBg: "#FB9678",
  ...
  {
    OrderID: 345653,
    CustomerName: "Parth Jain",
    TotalAmount: 56,
    OrderItems: "Quantum Computing",
    Location: "Science",
    Status: "published",
    StatusBg: "#8BE78B",
  ...
  },
  {
    ...
    CustomerName: "Meet Makwana",
    TotalAmount: 93,
    OrderItems: "A New Method for Chemical Synthesis of Organic Compounds",
    Location: "Journal of Organic Chemistry",
  ...
  },
  {
    ...
    CustomerName: "Dvij Pandya",
    TotalAmount: 23,
    OrderItems: "A Deep Learning Approach to Protein Structure Prediction",
    Location: "Nature",
    Status: "predatory",
    StatusBg: "red",
  ...
  {
    OrderID: 94757,
    CustomerName: "Yash Gandhi",
    TotalAmount: 95,
    OrderItems: "Computational Biology for Gene Expression Analysis",
    Location: "Cell",
    Status: "predatory",
    StatusBg: "#FF5C8E",
  ...
  {
    OrderID: 390457,
    CustomerName: "Khush Shah",
    TotalAmount: 93,
    OrderItems: "ML for Drug Discovery",
    Location: "IEEE Software",
    Status: "In process",
    StatusBg: "#03C9D7",
...
export const pieChartData = [
  { x: "Electronics & Communication", y: 18, text: "18%" },
  { x: "Computer Science", y: 8, text: "8%" },
  { x: "Instrumentation & Control", y: 15, text: "15%" },
  { x: "Electrical Enginnering", y: 11, text: "11%" },
  { x: "Civil Enginnering", y: 18, text: "18%" },
  { x: "Mechanincal Enginnering", y: 14, text: "14%" },
  { x: "Chemical Enginnering", y: 16, text: "16%" },
];
...
export const PyramidData = [
  { x: "M-Tech Students", y: 120, text: "120" },
  { x: "2nd year Students", y: 435, text: "435" },
  { x: "1st Year Students", y: 470, text: "470" },
  { x: "4th Year Students", y: 475, text: "475" },
  { x: "3rd Year Students", y: 520, text: "520" },
  { x: "Professors", y: 930, text: "930" },
];
